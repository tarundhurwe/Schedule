...
function Appointment({ value, onDelete, addSchedule }) {
        ...
        <>
            <div className="max-w-sm p-6 mb-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" style={{ minWidth: '25rem' }}>
                ...
                <div className="flex justify-between">
                    ...
                    <h3 className="text-l text-gray-900 dark:text-white">{value.location}</h3>
                </div>
                <br />
                <div className="flex justify-between">
                    <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900" onClick={openEditModal}>Edit</button>
                    {isEdit ? <EditAppointment closeEditModal={closeEditModal} value={value} onDelete={onDelete} addSchedule={addSchedule} /> : ""}
