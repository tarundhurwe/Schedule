...
function Appointment({ value, onDelete }) {
  ...
  return (
    <>
      <div
        className="max-w-sm p-6 mb-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
      ...
      >
        ...
        <div className="flex justify-between">
          ...
          <h3 className="text-l text-gray-900 dark:text-white">
            {value.email}
          </h3>
        </div>
        <hr />
