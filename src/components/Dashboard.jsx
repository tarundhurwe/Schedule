...
function Dashboard({ addSchedule, values, onDelete }) {
    ...
    return (
        <>
            <button data-modal-target="crud-modal" onClick={openModal} data-modal-toggle="crud-modal" className="block text-white mt-10 bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" type="button" style={{ margin: "auto", marginTop: "5rem" }}>
